...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function renderCart() {
      ...
      if (!cartItems || cartItems.length === 0) {
        ...
        <div class="p-3 rounded alert-info text-center" style="width: fit-content;">
            ...
            <a href="/index" class="btn btn-primary">Seguir comprando</a>
        </div>
        </div>`;
      ...
      cartItems.forEach((item, index) => {
        ...
        if (cartContainer) cartContainer.appendChild(card);
      });
    ...
    function finalizarCompra() {
        ...
        if (!cartItems || cartItems.length === 0) {
            showToast('error','Tu carrito está vacío. Agrega productos antes de finalizar la compra.');
            return;
        }
